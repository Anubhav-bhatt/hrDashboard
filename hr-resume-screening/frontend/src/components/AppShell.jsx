...
/* Minimalistic Mode Navigation Items (Step 8: Task-First) */
            ...
            >
              ...
              {!isCollapsed && (
                <span className="min-w-0">
                  ...
                  <span className="text-[10px] text-brand-600 font-semibold block mt-0.5">Minimal Workspace</span>
                </span>
              )}
            </Link>
          </div>

          {/* Minimal Navigation Content */}
          <div className="flex-1 overflow-y-auto scroll-slim py-4 space-y-4">
            {/* Home */}
            <nav aria-label="Main navigation" className="space-y-1">
              <div className="space-y-0.5 px-2">
                {MINIMAL_MAIN_NAV.map((item) => {
            ...
            {/* Hiring Navigation */}
            <nav aria-label="Hiring navigation" className="space-y-1">
              {!isCollapsed && (
            ...
            {aiEnabled && (
              <nav aria-label="Assistant navigation" className="space-y-1">
                {!isCollapsed && (
                  <p className="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
                    ASSISTANT
                  </p>
                ...
                <div className="space-y-0.5 px-2">
                  {MINIMAL_ASSISTANT_NAV.map((item) => {
